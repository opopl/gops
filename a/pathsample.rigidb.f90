!
      ...
      USE COMMON, ONLY: NTSITES, RBSITE, DBPT, DBPTDT, MSSTOCKT, STOCKAAT, EFIELDT
...
!     ----------------------------------------------------------------------------------------------
      ...
      USE COMMON, ONLY: NTSITES, RBSITE, STOCKAAT
...
!     ----------------------------------------------------------------------------------------------
      ...
      USE COMMON, ONLY: NRBSITES, RBSITE
