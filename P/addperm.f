...
C
      ...
      DOUBLE PRECISION LPOINTS(NR), LDUMMY,NIX,NIY,NIZ,LPOINTSTS(NR),LPLUS(NR),
     1                 LMINUS(NR), FRICTIONFAC
...
C
     ...
     1                 'permuting atoms 1 and ',J1,' for ts ',DOTS,' gives old transition state ',J2
         ...
         IYTS(NTS)=NIY
         IZTS(NTS)=NIZ
         WRITE(UTS,REC=NTS) (LPOINTS(J2),J2=1,NR)
...
!              ENDIF
         ...
         WRITE(UMIN,REC=NMIN) (LPOINTS(J2),J2=1,NR)
