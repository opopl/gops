...
USE COMMONS, ONLY: NATOMS,NR,UMIN, CONNECTMIN1, CONNECTMIN2, CONNECTDIST, DMIN1, DMIN2, TCONNECTDIST, TOPPOINTER, POINTERP, &
...
DOUBLE PRECISION SPOINTS(NR), FPOINTS(NR), ELAPSED, TNEW, DISTANCE, RMAT(3,3), DIST2
