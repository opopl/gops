MODULE COMMONS
     ...
     &        INTCONSEP, INTREPSEP, PAIRDISTMAX, PAIRDIST1, PAIRDIST2
...
! NRWBINS
     ...
     &                 PAIRTHRESH, MAXBREAK, PRODTHRESH, PBTHRESH, OMEGA, EINC, EDELTAMIN, RWBINWIDTH, RWEMAX, RWEMIN, &
...
! NATOMS
     ...
     &        DIJKSTRAT, DIJPAIRT, DIJINITT, EXTRACTMINT, EXTRACTTST, DIJKSTRAWAITT, &
     ...
     &        DBPT, DBPTDT, EFIELDT, MSSTOCKT, NTIPT, PAHAT, PATCHYDT, STOCKAAT, RBAAT, RBSYMT, TRAPT, OHCELLT
...
!     DC430 >
      INTEGER :: NRBSITES, NTSITES, NRBGROUP, PAHID, TIPID
