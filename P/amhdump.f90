...
!
      ...
      INTEGER MEMIRES(800)
      DOUBLE PRECISION CPRCORD_X(NR),CPRCORD_Y(NR),CPRCORD_Z(NR)
      DOUBLE PRECISION NITCORD_X(NR),NITCORD_Y(NR),NITCORD_Z(NR)
...
201        FORMAT (25(I2,1X))
         ...
         DO JTGRES = 0,NRES-1 
          PRINT '(A,5I6)','NATOMS,NR,NRES,JTGRES,9*(JTGRES+1)+1=',NATOMS,NR,NRES,JTGRES,9*(JTGRES+1)+1
...
201        FORMAT (25(I2,1X))
      ...
      READ(UMIN,REC=NUM) (LOCALPOINTS(J2),J2=1,NR)
...
300     CONTINUE
      ...
      READ(UMIN,REC=NUMNUM) (LOCALPOINTS(J2),J2=1,NR)
