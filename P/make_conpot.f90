...
USE COMMONS, ONLY : INTCONSEP, NREPMAX, NREPULSIVE, CONDISTREF, DEBUG, REPCON, INTCONSTRAINTREP, &
...
DOUBLE PRECISION :: DUMMY, NDIST, CONDIST(NATOMS), MINCOORDS(NCPFIT,NR), DMIN, LINTCONSTRAINTTOL
LOGICAL CHANGED
...
USE COMMONS, ONLY : NREPMAX, NREPULSIVE, CONDISTREF, DEBUG, INTCONSTRAINTDEL, &
...
DOUBLE PRECISION DUMMY, REPGRAD(3), INtCONST, D12, DSQ0, DSQP, DSQI, COORDS1(NR), COORDS2(NR)
LOGICAL NOINT
...
USE COMMONS, ONLY: FROZEN, FREEZE, NREPI, NREPJ, NNREPULSIVE, DEBUG, &
...
DOUBLE PRECISION XYZ(NR*(INTIMAGE+2)), GGG(NR*(INTIMAGE+2)), EEE(INTIMAGE+2)
...
USE COMMONS, ONLY: FROZEN, FREEZE, DEBUG, INTIMAGE, ATOMACTIVE, INTLJDEL, INTLJEPS, NATOMS
IMPLICIT NONE
...
DOUBLE PRECISION XYZ(NR*(INTIMAGE+2)), GGG(NR*(INTIMAGE+2)), XLOCAL(6*NATOMS), GLOCAL(6*NATOMS)
