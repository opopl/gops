...
USE COMMONS, ONLY: UMIN, NR, NATOMS, DMIN1, DMIN2, DIJINITT, NATTEMPT, NCPU
USE COMMONS, ONLY: PSCALE, DSCALE, BULKT, TWOD, ZSYM, DEBUG, GPFOLD, NMIN 
USE COMMONS, ONLY :  NPAIRFRQ, PAIR1, PAIR2, NPAIRFRQ, NPAIRDONE, MAXPAIRS
USE COMMONS, ONLY: PERMDIST, BOXLX, BOXLY, BOXLZ, RIGIDBODY, ANGLEAXIS 
USE COMMONS, ONLY : INTERPCOSTFUNCTION
USE PORFUNCS
...
DOUBLE PRECISION SPOINTS(NR), FPOINTS(NR), DISTANCE, RMAT(3,3), DIST2
...
IF (NAVAIL.EQ.0) THEN
   ...
   DO J1=1,NMIN
      ...
      READ(UMIN,REC=J1) (SPOINTS(J2),J2=1,NR)
      min2: DO J2=J1+1,NMIN
         ...
         ENDDO
         READ(UMIN,REC=J2) (FPOINTS(J3),J3=1,NR)
         CALL MINPERMDIST(SPOINTS,FPOINTS,NATOMS,DEBUG,BOXLX,BOXLY,BOXLZ,&
                & BULKT,TWOD,DISTANCE,DIST2,RIGIDBODY,RMAT,.FALSE.)
