...
USE COMMON, ONLY: DUMMYRUNT, AMBERT, NCPU, CHARMMT, UNRST,EXECGMIN
USE KEY
IMPLICIT NONE
...
SUBROUTINE SSHSUBMITGMIN(ICPU,STAT,JOBSTRING,CONNSTR1,DIRSTRING)
          USE NODES
          USE PORFUNCS
          USE COMMON, ONLY: CHARMMT, ZSYM, DEBUG, TRIPLES, COPYFILES, COPYOPTIMT, BHINTERPT
          IMPLICIT NONE
...
USE PORFUNCS
USE NODES, ONLY: SSHSUBMIT, SSHPARALLEL
USE COMMON, ONLY: DUMMYRUNT, AMBERT, NCPU, CHARMMT, UNRST,EXEC
USE KEY
implicit none
...
SUBROUTINE SSHSUBMITFRQ(ICPU,STAT,JOBSTRING,CONNSTR1,DIRSTRING,CONNSTR2)
          USE NODES
          USE PORFUNCS
          USE COMMON, ONLY: CHARMMT, ZSYM, DEBUG, TRIPLES, COPYFILES, COPYOPTIMT, BHINTERPT, AMBERT
          IMPLICIT NONE
