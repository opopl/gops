...
SUBROUTINE MYGA_BLN_MATE(ISTRUC,JSTRUC,CURR_STRUC)
   ...
   POS=INT(DPRAND()*NATOMS)+1
   IF(DPRAND().LT.0.5) THEN
      !Start with i structure
      DO I=1,POS*3
         MYGA_POP_GENOME(I,CURR_STRUC)=MYGA_POP_GENOME(I,ISTRUC)
      ENDDO
      DO I=1+POS*3,NATOMS*3
         MYGA_POP_GENOME(I,CURR_STRUC)=MYGA_POP_GENOME(I,JSTRUC)
      ENDDO
   ELSE
      !Start with j structure
      DO I=1,POS*3
         MYGA_POP_GENOME(I,CURR_STRUC)=MYGA_POP_GENOME(I,JSTRUC)
      ENDDO
      DO I=1+POS*3,NATOMS*3
