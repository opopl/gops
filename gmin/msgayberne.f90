      ...
      USE COMMONS, ONLY : NATOMS, NGBSITE, GBKAPPA, GBKAPPRM, GBMU, GBNU, GBCHI, GBCHIPRM, SIGNOT, EPSNOT
      ...
      IF (GTEST) THEN
         ...
         DO J1 = 1, NMOL - 1
            ...
            CALL ROTMAT (PI, RMI, DRMI1, DRMI2, DRMI3)
            ...
            DO I = 1, NGBSITE
               ...
               DO J2 =  J1 + 1, NMOL
                  ...
                  CALL ROTMAT (PI, RMI, DRMJ1, DRMJ2, DRMJ3)
