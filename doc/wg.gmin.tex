...
\ksec{ARM}{ arma armb\/}: Use the acceptance-ratio method 
...
are needed for different potentials. \keyw{SLOPPYCONV} can be used instead.
...
\keyw{TIGHTCONV} can be used instead.
...
quenches. If this criterion is too strict then the run time will be greatly increased.
If it is too sloppy then the performance of the algorithm is impaired. Different values
are needed for different potentials.{\keyw{BASIN} can be used instead.
