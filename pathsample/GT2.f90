...
MODULE GRAPHTRANSFORMATIONMODULE
     ...
     SUBROUTINE SPARSEGRAPHTRANSFORMATION
          USE COMMON, ONLY:DEBUG,SWITCH=>GT2SWITCH,RSWITCH=>GT2RSWITCH,DisconnectSources=>GT2DisconnectSources
     ...
     SUBROUTINE DenseGraphTransformation
          ...
          USE COMMON, ONLY:DEBUG,DisconnectSources=>GT2DisconnectSources
          IMPLICIT NONE
...
!         CALL PRINTMATRIX(SIZE(P,1),SIZE(P,2),P) ! DJW
  ...
  &                        ' real*8 elements'
     ...
     SUBROUTINE DGTOutput(IFIRST,SFIRST)
          ...
          USE COMMON, ONLY:DEBUG,DIRECTION,DisconnectSources=>GT2DisconnectSources
          IMPLICIT NONE
