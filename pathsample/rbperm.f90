...
!     ----------------------------------------------------------------------------------------------
      ...
      USE COMMON, ONLY : NATOMS, NRBSITES, NTSITES, NRBGROUP, RBSITE, RBOPS, EFIELDT, RBSYMT
      USE COMMON,ONLY : NPERMGROUP, NPERMSIZE, PERMGROUP, NSETS, SETS, GEOMDIFFTOL
      ...
      DO J1 = 1, NPERMGROUP
         ...
         PATOMS = NPERMSIZE(J1)
          IF (PATOMS.GT.NRB) THEN
             PRINT '(A,I6,A,I6,A,I6)',' minpermdist> ERROR *** number of permutable sites in group ',J1,' is ',PATOMS, &
...
!     GENERATE SITE POSITIONS FROM THE RIGID-BODY COORDINATES
      ...
      USE COMMON, ONLY: NATOMS, NTSITES, NRBSITES, RBSITE, DBPTDT
...
!     ----------------------------------------------------------------------------------------------
      ...
      USE COMMON, ONLY: NRBSITES, NTSITES, EFIELDT      
!                        
...
!
      ...
      ENDDO
!      PRINT '(A,I6,F20.10)',' rborient> JMAX1,DMAX=',JMAX1,DMAX
