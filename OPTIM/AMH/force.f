...
C        IRES  - CODED AMINO ACID SEQUENCE (I)
         ...
         USE AMHGLOBALS,  ONLY: MAXTAB,AMHMAXSIZ,MAXCNT,MAXPRO,MAXCRD,
...
C     ARGUMENT DECLARATIONS:
         ...
         INTEGER NUMPRO,CRDIXN(MAXTAB,2),MAXR,NUMLNG(0:AMHMAXSIZ,MAXTAB),NMRES,
     *           ILONG(MAXCNT,2,MAXTAB),IRES(AMHMAXSIZ)
     
         DOUBLE PRECISION PRCORD(AMHMAXSIZ,3,MAXPRO,MAXCRD),
     *        ZRCORD(AMHMAXSIZ,3,MAXPRO,MAXCRD),F_CORD(AMHMAXSIZ,3,MAXCRD),PRO_CORD(AMHMAXSIZ,3,MAXCRD),
     ...
     *        FRCORD(AMHMAXSIZ,3,MAXPRO,MAXCRD)
