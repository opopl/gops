...
c     RAMA figures out chiral forces 
      ...
      use amhglobals,  only:AMHmaxsiz,maxcrd,aps
...
c     argument declarations:
     ...
     *        adir(0:AMHmaxsiz+1,3,2),
     *        bdir(0:AMHmaxsiz+1,3,2),w(6),
     *        cdir(0:AMHmaxsiz+1,3,2),
     *        a2,b2,c2,adb,adc,bdc,bxa(3),cdbxa,
     *        chi,quad,phi(AMHmaxsiz),psi(AMHmaxsiz),
     *        slope(2),prob(AMHmaxsiz),
     *        pkappa1,pkappa2,
...
c        pchi=DMAX1(DMIN1(pchi,0.99999999999999D9),-0.9999999999999999D9)
