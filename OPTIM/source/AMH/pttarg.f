...
c     --------------------- pttarg ----------------------
      ...
      subroutine pttarg(AMHmaxsiz,nmres,numcrd,target,
...
c     argument declarations:
         ...
         integer maxres
         integer AMHmaxsiz,nmres,ires(maxres),jres(AMHmaxsiz),
     *           tarpre(AMHmaxsiz),mempre(AMHmaxsiz),oarchv,numcrd

         double precision target(AMHmaxsiz,3,numcrd),hydseq(maxres,2),
     *      ywork(maxres,3,numcrd),shydro(AMHmaxsiz,2),bondln(AMHmaxsiz,numcrd)
...
c      write(oarchv,100)AMHmaxsiz,nmres
c  100 format('Pttarg:AMHmaxsiz ',i3,' nmres ',i3)
