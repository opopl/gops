      SUBROUTINE GBD (NATOMS, X, G, ENERGY, GTEST, STEST)

      USE MODHESS
      USE KEY, ONLY: GBSIGNOT, GBEPSNOT, GBMU, GBNU, GBKAPPA, GBCHI, GBCHIPRM 

      IMPLICIT NONE

      INTEGER          :: NATOMS, I, J, J1, J2, J3, J4, J5, J6, K, REALNATOMS, OFFSET
      DOUBLE PRECISION :: X(3*NATOMS), G(3*NATOMS)
      DOUBLE PRECISION :: SCSIG, SCSIG3, ENERGY, SIGMAF, INVKAP
...
!     CALCULATE DEL(V)/DEL(\ALPHA) AND DEL(V)/DEL(\BETA)
               ...
               FCT10  = 24.D0*GBMU*GBCHIPRM*EPS/(SIGMAF*EPS2)
...
!     HESSIAN CALCULATION
               ...
               DVRDR  = (624.D0*SRM12*SRM2-168.D0*SRM6*SRM2)*EPS/(SIGMAF*SIGMAF)
               DVRDA  = FCT10*FCT9*FCT7P8-DVRDR*DSIGDA
               DVRDB  = FCT10*FCT9*FCT7M8-DVRDR*DSIGDB


               DVADR  = -FCT12*FCT3P4*(26.D0*SRM12*SRM2-7.D0*SRM6*SRM2)/SIGMAF & 
                      + 6.D0*FCT11*FCT9*FCT7P8/SIGMAF

               DVBDR  = -FCT12*FCT3M4*(26.D0*SRM12*SRM2-7.D0*SRM6*SRM2)/SIGMAF &
                      + 6.D0*FCT11*FCT9*FCT7M8/SIGMAF
               ...
               D2VDA2 = -FCT11*FCT12*FCT9*FCT3P4*FCT7P8/(4.D0*EPS) &
                      ...
                      -6.D0*FCT11*FCT9*FCT7P8)*(DSIGDA/SIGMAF) + 3.D0*FCT12*FCT9*FCT3P4 &
               ...
               D2VDB2 = -FCT11*FCT12*FCT9*FCT3M4*FCT7M8/(4.D0*EPS) &
                      ...
                      -6.D0*FCT11*FCT9*FCT7M8)*(DSIGDB/SIGMAF) + 3.D0*FCT12*FCT9*FCT3M4 &
               ...
               DVADB  = -FCT11*FCT12*FCT9*FCT3P4*FCT7M8/(4.D0*EPS)+ &
                      ...
                      +(FCT12*(26.D0*SRM12*SRM2-7.D0*SRM6*SRM2)*FCT3P4 &
                      -6.D0*FCT11*FCT9*FCT7P8)*(DSIGDB/SIGMAF) + 3.D0*FCT12*FCT9*FCT3P4 &
               ...
               D2VDG2 = FCT19*FCT15-FCT20*FCT15+4.D0*EPS*SR12M6* &
                      ...
                      *GBCHIPRM*GBCHIPRM*(FCT7*FCT7-FCT8*FCT8)/EPS2 &
                      ...
                      /EPS2)-FCT20*FCT15+FCT18*FCT16*GBCHI*GBCHI*SCSIG3*INVKAP* &
                      (26.D0*SRM12*SRM2-7.D0*SRM6*SRM2)/4.D0+FCT20* &
                      FCT16*SCSIG*SCSIG*3.D0*GBCHI*GBCHI/4.D0 + 12.D0*EPS* &
                      GBCHI*GBCHI*GBCHI*INVKAP*SCSIG3*FCT9*(FCT3*FCT3*FCT1+FCT4*FCT4*FCT2)


               DVGDA  =-FCT19*GBCHIPRM*GBMU*FCT7P8/EPS2+3.D0*GBCHI*SCSIG3*INVKAP &
                      ...
                      *SCSIG3*FCT18*(26.D0*SRM12*SRM2-7.D0*SRM6*SRM2)*INVKAP* &
                      FCT3P4-1.5D0*GBCHI*SCSIG*SCSIG*FCT20*FCT3P4- 12.D0* &
                      EPS*GBCHI*GBCHI*INVKAP*SCSIG3*FCT9*(FCT3*FCT1-FCT4*FCT2)

               DVADG  = DVGDA

               DVGDB  = -FCT19*GBCHIPRM*GBMU*FCT7M8/EPS2+3.D0*GBCHI*SCSIG3*INVKAP &
               ...
               DVRDG  = (-24.D0*EPS*FCT9*FCT15 + FCT21*FCT18)/SIGMAF
