...
! Stuff for dumping normal mode info
      ...
      LOGICAL MDSTEPT, readcoords, NOCISTRANSRNA, NOCISTRANSDNA, CHECKCISTRANSALWAYS, CHECKCISTRANSALWAYSRNA, CHECKCISTRANSALWAYSDNA
      LOGICAL GOODSTRUCTURE1, GOODSTRUCTURE2, AMBERENERGIEST, UACHIRAL, SETCHIRAL
...
!      DOUBLE PRECISION    tt,crd(3*656),vel(3,656)
       INTEGER MYUNITNEW, MDINFO_UNIT, MDCRD_UNIT, AMBRST_UNIT, AMBPDB_UNIT
...
!
! Variables for steered minimisation.
!
...
INTEGER :: NATOMSINA, NATOMSINB
INTEGER,ALLOCATABLE,DIMENSION(:) :: ATOMSINALIST, ATOMSINBLIST  
LOGICAL,ALLOCATABLE,DIMENSION(:) :: ATOMSINALISTLOGICAL, ATOMSINBLISTLOGICAL
