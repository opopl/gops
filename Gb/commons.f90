...
PARAMETER(LFN="gmi.log")
      ! }}}
      ! integer {{{
     INTEGER :: NATOMS,NS,NACCEPT,MAXIT,MAXIT2,NTARGETS,NSEED,NSAVE,MCSTEPS
     INTEGER :: NSSTOP
     ...
     DOUBLE PRECISION :: TFAC,RMS,DGUESS,EPSSPHERE
...
!   allocatables {{{
      ...
      DOUBLE PRECISION :: TEMP, STEP, OSTEP, ASTEP, ACCRAT, EPREV ! dimension will be NPAR 
      ...
      LOGICAL :: FIXBOTH, FIXTEMP, FIXSTEP, JUMPMOVE, JDUMP, TMOVE, OMOVE ! dimension will be NPAR
