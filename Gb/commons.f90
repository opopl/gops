     ...
     INTEGER :: NATOMS,NS,NACCEPT,MAXIT,NTARGETS,NSEED,NSAVE,MCSTEPS(3),NRUNS,MUPDATE,NRELAX,MYUNIT,
     &        MYEUNIT, MYMUNIT, MYBUNIT, MYRUNIT, MYPUNIT,
     &        mynode
 
     DOUBLE PRECISION :: RADIUS,BQMAX,MAXBFGS,ECONV,GMAX,TFAC(3),RMS,DGUESS,EPSSPHERE,MAXERISE,MAXEFALL
